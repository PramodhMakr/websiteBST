    ...
    <div className="min-h-screen bg-gray-900">
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-2 gap-12 items-center mb-20">
            <div>
              <h2 className="text-3xl sm:text-4xl font-bold text-white mb-6">Why Work With BST InfoSec?</h2>
              <div className="space-y-4">
                {benefits.map((benefit, idx) => (
                  <div key={idx} className="flex items-start space-x-4">
                    <benefit.icon className="h-6 w-6 text-cyan-400 mt-1 flex-shrink-0" />
                    <div>
            ...
            <div className="bg-gradient-to-br from-cyan-500/10 to-blue-500/10 rounded-2xl border border-cyan-500/20 p-8 backdrop-blur-sm">
              <img
                src="/src/assets/stripped-03.jpg"
                alt="Team Culture"
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-950/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl sm:text-4xl font-bold text-white mb-4">Our Roles & Services</h2>
          ...
          <div className="grid md:grid-cols-3 gap-6 mb-16">
            {[
              ...
              <div key={idx} className="bg-gray-800/40 p-6 rounded-xl border border-cyan-500/10 hover:border-cyan-500/30 transition-all">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-8">
            {openPositions.map((position, index) => (
              <div
                key={index}
                className="bg-gray-800/40 p-10 rounded-xl border border-cyan-500/20 hover:border-cyan-500/40 transition-all"
              >
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-6">
                  ...
                  <a
                    ...
                    className="inline-flex items-center px-6 py-3 bg-cyan-500 text-white font-semibold rounded-lg hover:bg-cyan-600 transition-all h-fit"
                  >
                    Apply Now
                  </a>
                </div>
                ...
                <div>
                  <h4 className="text-lg font-semibold text-white mb-4">What We're Looking For:</h4>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 bg-gradient-to-r from-cyan-500/10 to-blue-500/10 border-y border-cyan-500/20">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <a
            href="mailto:careers@bstinfosec.com"
            className="inline-flex items-center justify-center px-8 py-4 bg-gray-800 text-white font-semibold rounded-lg hover:bg-gray-700 border border-cyan-500/30 transition-all"
          >
